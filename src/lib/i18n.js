export const getDefaultLocale = () => {
  if (typeof window === 'undefined') {
    return process.env.DEFAULT_LANG || 'en-US'
  }
  return 'en-US'
}

export const defaultLocale = (typeof process !== 'undefined' && process.env && process.env.DEFAULT_LANG) ? process.env.DEFAULT_LANG : 'en-US'
