...
export function MutesTab() {
  ...
  const unmuteAction = useActionButton(async () => {
  ...
  const { cleanup: unmuteCleanup } = unmuteAction
  ...
  }, [submitCleanup, unmuteCleanup, deleteCleanup])
  ...
  return (
    <>
      ...
      <MuteForm open={dialogOpen} onOpenChange={setDialogOpen} editingMute={editingMute} formData={formData} setFormData={setFormData} onSubmit={handleSubmit} onCancel={handleCancel} isLoading={submitAction.isLoading} />
      ...
      <AlertDialog open={unmuteAlert.open} onOpenChange={(open) => setUnmuteAlert({ open, mute: null, reason: '' })}>
        <AlertDialogContent className="bg-zinc-900 border-zinc-800">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleUnmuteConfirm} disabled={unmuteAction.isDisabled} className="bg-green-600 hover:bg-green-700 text-white disabled:opacity-50 disabled:cursor-not-allowed">
              {unmuteAction.isLoading ? (
                <>
