...
export function Header() {
  ...
  const [panelName, setPanelName] = useState("SimplePanel")
      ...
      <div className="px-4 md:px-6 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/assets/logo.png" width={64} height={64} alt={`${panelName}-logo`} />
            <h1 className="text-zinc-100 text-lg md:text-xl">{panelName}</h1>
          </Link>
